    ...
    <div className="flex-1 flex flex-col p-1 space-y-3">
      ...
      <div className="grid grid-cols-3 gap-1.5 p-1.5 bg-brand-sand rounded-2xl border-2 border-brand-sand">
        {[
          ...
          { id: 'grounding', label: '五官著陸', icon: <Eye className="w-4 h-4" /> },
            ...
            >
              ...
              <div className="flex gap-2.5 max-w-sm mx-auto w-full items-center justify-between">
                ...
                <button
                  ...
                  className={`p-3 border rounded-xl cursor-pointer active:scale-95 transition flex items-center justify-center ${
                    isVoiceEnabled 
              ...
              <div className="text-center select-none pb-1">
                <p className="text-[11px] font-medium text-slate-400 mt-1">建議在家長或教師陪同下進行</p>
              </div>
            </motion.div>
          )}
              ...
              {!isGroundingStarted ? (
                ...
                <div className="flex-1 flex flex-col justify-between space-y-4 py-2">
                  <div className="text-center space-y-2">
                    ...
                    <h3 className="text-lg font-black text-gray-800">5-4-3-2-1 五官著陸</h3>
                  ...
                  <div className="space-y-3 max-w-xs mx-auto w-full">
                    <button
                      onClick={() => {
                        ...
                        setGroundingStep(1);
                        setGroundingChecked({});
                        safeSpeak("開始五官著陸練習。第一步，視覺：尋找 5 件目光所及的事物。觀看身處空間內的事物即可，例如窗外的樹、桌上的筆、牆上的時鐘。");
                      }}
                    ...
                    <p className="text-[11px] font-medium text-center text-slate-400 mt-1">
                      建議在家長或教師陪同下進行
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex gap-2.5 max-w-sm mx-auto w-full items-center justify-between">
                    <button
                      onClick={() => {
                        ...
                        if (groundingStep < 5) {
                          ...
                          if (nextStep === 3) safeSpeak("第三步，聽覺：尋找 3 種可以聽見的聲音。靜心聆聽即可，例如身邊同學或老師的聲音。");
                          ...
                          safeSpeak("太棒了！你完成了五官著陸練習！你做得真棒！");
                        }
                      }}
                    ...
                    <button
                      onClick={() => {
                        ...
                        if (groundingStep === 3) text = "👂 第三步，聽覺：尋找 3 種可以聽見的聲音。靜心聆聽即可，例如身邊同學或老師的聲音。";
          ...
          {activeTool === 'haven' && (
            ...
            >
              {!isGuiding ? (
                ...
                <div className="flex-1 flex flex-col items-center justify-center space-y-5 py-3 my-auto max-w-xs mx-auto w-full">
                  <div className="text-center space-y-2">
                    <div className="w-16 h-16 bg-brand-sage/10 text-brand-sage rounded-full flex items-center justify-center mx-auto shadow-inner border border-brand-sage/20">
                  ...
                  <div className="w-full space-y-2 text-center">
                    <button
                      ...
                      className="w-full py-3 bg-brand-sage hover:bg-brand-moss text-white rounded-[100px] text-xs sm:text-sm font-black tracking-wider transition shadow-md active:scale-95 cursor-pointer border-0 flex items-center justify-center gap-2"
                      style={{ minHeight: '44px' }}
                    >
                    ...
                    <p className="text-[11px] font-medium text-slate-400">建議在家長或教師陪同下進行</p>
                  </div>
                </div>
              ) : (
